...
import { updateUserPassword } from "/services/authenticationServices";
import checkValidField from "/components/validations/field";

export default function UpdateUserPasswordModal({ success }) {
        ...
        >
            ...
            <Grid item xs={12} lg={12}>
                <TextForm
                    title="Mật khẩu cũ"
                    required
                    subtitle="Nhập mật khẩu cũ"
                    value={formData.oldPassword}
                    error={formData.oldPasswordError.hasError}
                    errorLabel={formData.oldPasswordError.label}
